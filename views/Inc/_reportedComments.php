        ...
        ?>
            <tbody align="center">
                <tr>
                    ...
                    <td><a href="?controller=PostController&action=showAction&id=<?= $comment->getPostId() ?>" title="Voir le commentaire"><?= substr (nl2br(html_entity_decode($comment->getContent())), 0, 25) . '...' ?></a></td>
                    ...
                    <td>
                        <a href="?controller=AdminController&action=deleteCommentAction&id=<?= $comment->getId() ?>" title="Supprimer le commentaire" onclick="return(confirm('Souhaitez-vous supprimer définitivement ce commentaire ?'))">
        ...
        <div class="panel panel-default">
            ...
            <div id="collapseId<?= $comment->getId() ?>" class="panel-collapse collapse">
                <div class="panel-body">
                    Commentaire : <a href="?controller=PostController&action=showAction&id=<?= $comment->getPostId() ?>" title="Voir le commentaire"><?= nl2br(html_entity_decode($comment->getContent())) ?></a>
                </div>
                <div class="panel-body">
