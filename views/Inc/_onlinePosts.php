    ...
    foreach ($posts as $post)
    {
        ...
        <tr>
            ...
            <td><a href="?controller=PostController&action=showAction&id=<?= $post->getId() ?>"
                   title="Voir l'article"><?= (html_entity_decode($post->getTitle())) ?></a></td>
            ...
            <td>
                <a href="?controller=AdminController&action=deletePostAction&id=<?= $post->getId() ?>"
                   ...
                   onclick="return(confirm('Souhaitez-vous vraiment supprimer cet article ?'))">
        ...
        <div class="panel panel-default">
            ...
            <div id="collapse<?= $post->getId() ?>" class="panel-collapse collapse">
                <div class="panel-body">
                    <a href="?controller=PostController&action=showAction&id=<?= $post->getId() ?>" title="Voir l'article">Lire le billet</a>
                </div>
                <div class="panel-body">
                ...
                <div class="panel-body text-center">
                    <a href="?controller=AdminController&action=editPostAction&id=<?= $post->getId() ?>" title="Modifier l'article">
                        Modifier&nbsp;<i class="fas fa-pencil-alt"></i>
                    </a>
                    <!-- espace 'cradatin' x2 = tabulation -->
                    &emsp;&emsp;
                    <a href="?controller=AdminController&action=deletePostAction&id=<?= $post->getId() ?>" title="Supprimer l'article" onclick="return(confirm('Souhaitez-vous vraiment supprimer cet article ?'))">
